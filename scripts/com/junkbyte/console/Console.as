    ...
    public class Console extends Sprite {
        ...
        public function Console(param1:String = "", param2:ConsoleConfig = null) {
            ...
            this.cl.addCLCmd("remotingSocket",function(param1:String = ""):void {
                var _local_2:Array = param1.split(/\s+|\:/);
        ...
        public function listenUncaughtErrors(param1:LoaderInfo) : void {
            ...
            try {
                _local_2 = param1["uncaughtErrorEvents"];
                if(_local_2) {
        ...
        private function uncaughtErrorHandle(param1:Event) : void {
            ...
            var _local_2:* = !!param1.hasOwnProperty("error")?param1["error"]:param1;
            if(_local_2 is Error) {
                _local_3 = this._refs.makeString(_local_2);
            } else if(_local_2 is ErrorEvent) {
        ...
        private function _onEnterFrame(param1:Event) : void {
            ...
            if(this.remoter.remoting != Remoting.RECIEVER) {
                _local_4 = this._graphing.update(!!stage?Number(stage.frameRate):Number(0));
            }
        ...
        public function addLine(param1:Array, param2:int = 0, param3:* = null, param4:Boolean = false, param5:Boolean = false, param6:int = -1) : void {
            var _local_7:String = "";
            var _local_8:int = param1.length;
            var _local_9:int = 0;
            while(_local_9 < _local_8) {
                _local_7 = _local_7 + ((!!_local_9?" ":"") + this._refs.makeString(param1[_local_9],null,param5));
                _local_9++;
            }
            ...
            if(!param5 && param6 > 0) {
                _local_7 = _local_7 + this._tools.getStack(param6,param2);
            }
            this._logs.add(new Log(_local_7,MakeChannelName(param3),param2,param4,param5));
        }
