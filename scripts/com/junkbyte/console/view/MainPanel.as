package com.junkbyte.console.view {
    ...
    public class MainPanel extends ConsolePanel {
        ...
        private function onMouseWheel(param1:MouseEvent) : void {
            var _local_2:int = 0;
            if(this._shift) {
                _local_2 = console.config.style.traceFontSize + (param1.delta > 0?1:-1);
        ...
        private function updateBottom() : void {
            var _local_6:int = 0;
            var _local_1:String = "";
            var _local_2:int = Math.round(this._traceField.height / style.traceFontSize);
            var _local_3:int = Math.round(this._traceField.width * 5 / style.traceFontSize);
            var _local_4:Log = console.logs.last;
            var _local_5:* = this._viewingChannels.length != 1;
            while(_local_4) {
                if(this.lineShouldShow(_local_4)) {
                    _local_6 = Math.ceil(_local_4.text.length / _local_3);
        ...
        private function makeLine(param1:Log, param2:Boolean) : String {
            var _local_3:String = "<p>";
            if(param2) {
                _local_3 = _local_3 + param1.chStr;
            }
            if(config.showLineNumber) {
                _local_3 = _local_3 + param1.lineStr;
            }
            if(config.showTimestamp) {
                _local_3 = _local_3 + param1.timeStr;
            }
            var _local_4:String = "p" + param1.priority;
            return _local_3 + "<" + _local_4 + ">" + this.addFilterText(param1.text) + "</" + _local_4 + "></p>";
        }
        ...
        private function addFilterText(param1:String) : String {
            ...
            if(this._filterRegExp) {
                ...
                _local_2 = this._filterRegExp.exec(param1);
                while(_local_2 != null) {
                    ...
                    } else if(param1.lastIndexOf("<",_local_3) <= param1.lastIndexOf(">",_local_3)) {
                        param1 = param1.substring(0,_local_3) + "<u>" + param1.substring(_local_3,_local_3 + _local_4.length) + "</u>" + param1.substring(_local_3 + _local_4.length);
                        this._filterRegExp.lastIndex = this._filterRegExp.lastIndex + 7;
                    }
                    _local_2 = this._filterRegExp.exec(param1);
                }
            } else if(this._filterText) {
                _local_5 = param1.toLowerCase();
                _local_6 = _local_5.lastIndexOf(this._filterText);
                while(_local_6 >= 0) {
                    param1 = param1.substring(0,_local_6) + "<u>" + param1.substring(_local_6,_local_6 + this._filterText.length) + "</u>" + param1.substring(_local_6 + this._filterText.length);
        ...
        override public function set height(param1:Number) : void {
            ...
            if(height != param1) {
                this._mini = param1 < (!!this._cmdField.visible?_local_3 + _local_2 + 4:_local_3);
            }
            super.height = param1;
            var _local_4:Boolean = this._mini || !style.topMenu;
            this.updateTraceFHeight();
            this._traceField.y = !!_local_4?Number(0):Number(_local_2);
            this._traceField.height = param1 - (!!this._cmdField.visible?_local_2 + 4:0) - (!!_local_4?0:_local_2);
            var _local_5:Number = param1 - (_local_2 + 6);
            ...
            this._bottomLine.y = !!this._cmdField.visible?Number(_local_5):Number(param1);
            this._scroll.y = !!_local_4?Number(6):Number(_local_2 + 4);
        ...
        private function updateTraceFHeight() : void {
            ...
            this._traceField.y = !!_local_1?Number(0):Number(txtField.y + txtField.height - 6);
        ...
        public function getChannelsLink(param1:Boolean = false) : String {
            ...
            if(param1 && _local_4 > style.maxChannelsInMenu) {
        ...
        public function onMenuRollOver(param1:TextEvent, param2:ConsolePanel = null) : void {
            ...
            console.panels.tooltip(_local_3,param2);
        }
        ...
        public function onChannelPressed(param1:String) : void {
            ...
            if(this._ctrl && param1 != Console.GLOBAL_CHANNEL) {
                _local_2 = this.toggleCHList(this._ignoredChannels,param1);
                ...
                _local_2 = this.toggleCHList(this._viewingChannels,param1);
        ...
        private function toggleCHList(param1:Array, param2:String) : Array {
            ...
            var _local_3:int = param1.indexOf(param2);
            if(_local_3 >= 0) {
        ...
        private function updateCLSize() : void {
            ...
            if(this._cmdPrefx.width > 120 || this._cmdPrefx.width > _local_1) {
                ...
                this._cmdPrefx.width = _local_1 > 120?Number(120):Number(_local_1);
