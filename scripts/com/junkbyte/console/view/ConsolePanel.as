package com.junkbyte.console.view {
    ...
    public class ConsolePanel extends Sprite {
        ...
        private function updateScale(param1:Event = null) : void {
            ...
            this.width = _local_2.x < this.minWidth?Number(this.minWidth):Number(_local_2.x);
            this.height = _local_2.y < this.minHeight?Number(this.minHeight):Number(_local_2.y);
            this.updateScaleText();
        }
        ...
        private function getSnapOf(param1:Number, param2:Boolean) : Number {
            ...
            var _local_3:Number = param1 + this.width;
            var _local_4:Array = this._snaps[!!param2?0:1];
            var _local_5:int = this.style.panelSnapping;
            for each(_local_6 in _local_4) {
                if(Math.abs(_local_6 - param1) < _local_5) {
                    return _local_6;
                }
