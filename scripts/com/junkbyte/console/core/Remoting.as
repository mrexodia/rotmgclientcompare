package com.junkbyte.console.core {
    ...
    public class Remoting extends ConsoleCore {
        ...
        private function synchronize(param1:String, param2:Object) : void {
            ...
            var _local_3:ByteArray = param2 as ByteArray;
            var _local_4:ByteArray = this._recBuffers[param1];
            if(_local_4) {
                _local_4.position = _local_4.length;
                _local_4.writeBytes(_local_3);
            } else {
                this._recBuffers[param1] = _local_3;
            }
        }
        ...
        public function handleSocket(param1:Socket) : void {
            ...
            param1.readBytes(_local_2);
            this.synchronize(this._senders[param1],_local_2);
        }
