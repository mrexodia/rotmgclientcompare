package com.junkbyte.console.core {
    ...
    public class LogReferences extends ConsoleCore {
        ...
        public static function ShortClassName(param1:Object, param2:Boolean = true) : String {
            ...
            var _local_5:String = param1 is Class?"*":"";
            _local_3 = _local_5 + _local_3.substring(_local_4 >= 0?Number(_local_4 + 2):Number(0)) + _local_5;
            if(param2) {
        ...
        public function setLogRef(param1:*) : uint {
            ...
            var _local_2:uint = this._refRev[param1];
            if(!_local_2) {
                _local_2 = this._refIndex;
                this._refMap[_local_2] = param1;
                this._refRev[param1] = _local_2;
        ...
        private function genLinkString(param1:*, param2:*, param3:String) : String {
            ...
            var _local_4:uint = this.setLogRef(param1);
            if(_local_4) {
                return "<menu><a href=\'event:ref_" + _local_4 + (!!param2?"_" + param2:"") + "\'>" + param3 + "</a></menu>";
            }
            return param3;
        }
        ...
        private function handleString(param1:String) : void {
            ...
            if(param1 == "refexit") {
                ...
                _local_2 = param1.indexOf("_") + 1;
                if(_local_2 > 0) {
                    _local_4 = "";
                    _local_5 = param1.indexOf("_",_local_2);
                    if(_local_5 > 0) {
                        _local_3 = uint(param1.substring(_local_2,_local_5));
                        _local_4 = param1.substring(_local_5 + 1);
                    } else {
                        _local_3 = uint(param1.substring(_local_2));
                    }
        ...
        public function getPossibleCalls(param1:*) : Array {
            ...
            var _local_9:XMLList = null;
            var _local_10:XML = null;
            var _local_2:Array = new Array();
            var _local_3:XML = describeType(param1);
