    ...
    public class CommandLine extends ConsoleCore {
        ...
        public function handleScopeEvent(param1:uint) : void {
            ...
            if(remoter.remoting == Remoting.RECIEVER) {
                ...
                _local_2.writeUnsignedInt(param1);
                remoter.send("scope",_local_2);
            } else {
                _local_3 = console.refs.getRefById(param1);
                if(_local_3) {
        ...
        public function addCLCmd(param1:String, param2:Function, param3:String, param4:Boolean = false, param5:String = ";") : void {
            var _local_6:Array = param1.split("|");
            var _local_7:int = 0;
            while(_local_7 < _local_6.length) {
                param1 = _local_6[_local_7];
        ...
        public function addSlashCommand(param1:String, param2:Function, param3:String = "", param4:Boolean = true, param5:String = ";") : void {
            var _local_6:SlashCommand = null;
            param1 = param1.replace(/[^\w]*/g,"");
            if(this._slashCmds[param1] != null) {
                _local_6 = this._slashCmds[param1];
                if(!_local_6.user) {
        ...
        private function onExecLineComplete(param1:Event) : void {
            var _local_2:Executer = param1.currentTarget as Executer;
            if(this._scope == _local_2.scope) {
                this.setReturned(_local_2.returned);
            } else if(_local_2.scope == _local_2.returned) {
        ...
        private function reportError(param1:Error) : void {
            ...
            var _local_2:String = console.refs.makeString(param1);
        ...
        private function cmdsCmd(... rest) : void {
            var _local_4:SlashCommand = null;
            var _local_2:Array = [];
            var _local_3:Array = [];
        ...
        private function explodeCmd(param1:String = "0") : void {
            var _local_2:int = int(param1);
            console.explodech(console.panels.mainPanel.reportChannel,this._scope,_local_2 <= 0?3:int(_local_2));
        }
        ...
        private function funCmd(param1:String = "") : void {
            var _local_2:FakeFunction = new FakeFunction(this.run,param1);
