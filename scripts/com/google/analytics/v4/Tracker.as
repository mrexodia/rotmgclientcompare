    ...
    public class Tracker implements GoogleAnalyticsAPI {
        ...
        public function Tracker(param1:String, param2:Configuration, param3:DebugConfiguration, param4:Environment, param5:Buffer, param6:GIFRequest, param7:AdSenseGlobals, param8:Ecommerce) {
            ...
            if(!Utils.validateAccount(param1)) {
                _local_9 = "Account \"" + param1 + "\" is not valid.";
        ...
        public function trackEvent(param1:String, param2:String, param3:String = null, param4:Number = NaN) : Boolean {
            ...
            if(param1 != "" && param2 != "") {
                ...
                _local_5 = _eventTracker.setKey(EVENT_TRACKER_PROJECT_ID,EVENT_TRACKER_OBJECT_NAME_KEY_NUM,param1);
                _local_5 = _eventTracker.setKey(EVENT_TRACKER_PROJECT_ID,EVENT_TRACKER_TYPE_KEY_NUM,param2);
                if(param3) {
                    _local_5 = _eventTracker.setKey(EVENT_TRACKER_PROJECT_ID,EVENT_TRACKER_LABEL_KEY_NUM,param3);
                    _local_6 = 3;
                }
                if(!isNaN(param4)) {
                    _local_5 = _eventTracker.setValue(EVENT_TRACKER_PROJECT_ID,EVENT_TRACKER_VALUE_VALUE_NUM,param4);
                    _local_6 = 4;
                }
                if(_local_5) {
        ...
        private function _sendXEvent(param1:X10 = null) : void {
            var _local_2:Variables = null;
            var _local_3:EventInfo = null;
            var _local_4:Variables = null;
            var _local_5:Variables = null;
            if(_takeSample()) {
                _local_2 = new Variables();
                _local_2.URIencode = true;
                _local_3 = new EventInfo(true,_x10Module,param1);
        ...
        private function _formatReferrer() : String {
            ...
            var _local_3:URL = null;
            var _local_4:URL = null;
        ...
        public function addItem(param1:String, param2:String, param3:String, param4:String, param5:Number, param6:int) : void {
            var _local_7:Transaction = null;
            _local_7 = _ecom.getTransaction(param1);
            if(_local_7 == null) {
                _local_7 = _ecom.addTransaction(param1,"","","","","","","");
            }
            _local_7.addItem(param2,param3,param4,param5.toString(),param6.toString());
            if(_debug.active) {
        ...
        private function _renderMetricsSearchVariables(param1:String = "") : Variables {
            ...
            _local_2.URIencode = true;
            var _local_3:DocumentInfo = new DocumentInfo(_config,_info,_formatedReferrer,param1,_adSense);
        ...
        private function _trackMetrics(param1:String = "") : void {
            var _local_2:Variables = null;
            var _local_3:Variables = null;
            var _local_4:Variables = null;
            var _local_5:EventInfo = null;
            if(_takeSample()) {
                _local_2 = new Variables();
                _local_2.URIencode = true;
                ...
                _local_4 = _renderMetricsSearchVariables(param1);
