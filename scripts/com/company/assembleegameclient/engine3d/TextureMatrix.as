package com.company.assembleegameclient.engine3d {
    ...
    public class TextureMatrix {
        ...
        public function calculateTextureMatrix(param1:Vector.<Number>) : void {
            ...
            var _local_2:int = param1.length - 2;
            var _local_3:int = _local_2 + 1;
            this.tempMatrix_.a = param1[2] - param1[0];
            this.tempMatrix_.b = param1[3] - param1[1];
            this.tempMatrix_.c = param1[_local_2] - param1[0];
            this.tempMatrix_.d = param1[_local_3] - param1[1];
        ...
        public function calculateUVMatrix(param1:Vector.<Number>) : void {
            ...
            var _local_2:int = param1.length - 3;
            var _local_3:Number = param1[0] * this.texture_.width;
            var _local_4:Number = param1[1] * this.texture_.height;
            var _local_5:Number = param1[3] * this.texture_.width;
            var _local_6:Number = param1[4] * this.texture_.height;
            var _local_7:Number = param1[_local_2] * this.texture_.width;
            var _local_8:Number = param1[_local_2 + 1] * this.texture_.height;
