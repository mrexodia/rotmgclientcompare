    ...
    public class Map extends AbstractMap {
        ...
        override public function pSTopW(param1:Number, param2:Number) : Point {
            ...
            for each(_local_3 in this.visibleSquares_) {
                if(_local_3.faces_.length != 0 && _local_3.faces_[0].face_.contains(param1,param2)) {
        ...
        override public function setGroundTile(param1:int, param2:int, param3:uint) : void {
            var _local_8:int = 0;
            var _local_9:int = 0;
            var _local_10:Square = null;
            var _local_4:Square = this.getSquare(param1,param2);
            _local_4.setTileType(param3);
            var _local_5:int = param1 < width_ - 1?int(param1 + 1):int(param1);
            var _local_6:int = param2 < height_ - 1?int(param2 + 1):int(param2);
            var _local_7:int = param1 > 0?int(param1 - 1):int(param1);
            while(_local_7 <= _local_5) {
                _local_8 = param2 > 0?int(param2 - 1):int(param2);
                while(_local_8 <= _local_6) {
                    _local_9 = _local_7 + _local_8 * width_;
                    _local_10 = squares_[_local_9];
                    if(_local_10 != null && (_local_10.props_.hasEdge_ || _local_10.tileType_ != param3)) {
        ...
        public function internalAddObj(param1:BasicObject) : void {
            ...
            var _local_2:Dictionary = param1 is GameObject?goDict_:boDict_;
        ...
        override public function draw(param1:Camera, param2:int) : void {
            var _local_6:Square = null;
            var _local_13:GameObject = null;
            var _local_14:BasicObject = null;
            var _local_15:int = 0;
            ...
            var _local_7:int = param1.maxDist_;
            ...
            while(_local_12 <= _local_9) {
                ...
                while(_local_15 <= _local_11) {
                    ...
                    if(_local_6 != null) {
                        ...
                        if(_local_18 <= param1.maxDistSq_) {
                            _local_6.lastVisible_ = param2;
                            _local_6.draw(this.graphicsData_,param1,param2);
            ...
            for each(_local_13 in goDict_) {
                ...
                if(!_local_13.dead_) {
                    ...
                    if(!(_local_6 == null || _local_6.lastVisible_ != param2)) {
                        _local_13.drawn_ = true;
                        _local_13.computeSortVal(param1);
                        if(_local_13.props_.drawUnder_) {
                            if(_local_13.props_.drawOnGround_) {
                                _local_13.draw(this.graphicsData_,param1,param2);
                            } else {
            ...
            for each(_local_14 in boDict_) {
                ...
                if(!(_local_6 == null || _local_6.lastVisible_ != param2)) {
                    ...
                    _local_14.computeSortVal(param1);
            ...
            if(this.visibleUnder_.length > 0) {
                ...
                for each(_local_14 in this.visibleUnder_) {
                    _local_14.draw(this.graphicsData_,param1,param2);
                }
            }
            ...
            if(Parameters.data_.drawShadows) {
                for each(_local_14 in this.visible_) {
                    if(_local_14.hasShadow_) {
                        _local_14.drawShadow(this.graphicsData_,param1,param2);
                    }
                }
            }
            for each(_local_14 in this.visible_) {
            ...
            if(this.topSquares_.length > 0) {
                for each(_local_6 in this.topSquares_) {
                    _local_6.drawTop(this.graphicsData_,param1,param2);
                }
            }
            if(player_ != null && player_.breath_ >= 0 && player_.breath_ < Parameters.BREATH_THRESH) {
                ...
                _local_20 = Math.abs(Math.sin(param2 / 300)) * 0.75;
            ...
            if(Parameters.isGpuRender() && Renderer.inGame) {
                ...
                _local_22.dispatch(this.graphicsData_,this.graphicsData3d_,width_,height_,param1,_local_21);
                _local_23 = 0;
                while(_local_23 < this.graphicsData_.length) {
                    ...
                    } else if(this.graphicsData_[_local_23] is GraphicsSolidFill && GraphicsFillExtra.isSoftwareDrawSolid(GraphicsSolidFill(this.graphicsData_[_local_23]))) {
                        this.graphicsDataStageSoftware_.push(this.graphicsData_[_local_23]);
                        this.graphicsDataStageSoftware_.push(this.graphicsData_[_local_23 + 1]);
                        this.graphicsDataStageSoftware_.push(this.graphicsData_[_local_23 + 2]);
                    }
            ...
            if(player_ != null && (player_.condition_[ConditionEffect.CE_FIRST_BATCH] & ConditionEffect.MAP_FILTER_BITMASK) != 0) {
                _local_24 = [];
                if(player_.isDrunk()) {
                    _local_25 = 20 + 10 * Math.sin(param2 / 1000);
