package com.company.assembleegameclient.objects.particles {
    ...
    public class ParticleField extends BitmapParticle {
        ...
        private function onTimer(param1:TimerEvent) : void {
            var _local_2:Square = new Square#181(this.getStartPoint(),this.getEndPoint(),this.getLifespan());
        ...
        private function onSquareComplete(param1:Square#181) : void {
...
class Square#181 extends Shape {
    ...
    function Square#181(param1:Point, param2:Point, param3:uint) {
