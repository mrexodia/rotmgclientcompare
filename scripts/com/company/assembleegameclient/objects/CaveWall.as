package com.company.assembleegameclient.objects {
    ...
    public class CaveWall extends ConnectedObject {
        ...
        override protected function buildDot() : void {
            var _local_6:ObjectFace3D = null;
        ...
        override protected function buildShortLine() : void {
            var _local_9:ObjectFace3D = null;
        ...
        override protected function buildL() : void {
            var _local_11:ObjectFace3D = null;
            var _local_1:Vector3D = this.getVertex(0,0);
            var _local_2:Vector3D = this.getVertex(0,3);
        ...
        override protected function buildT() : void {
            var _local_13:ObjectFace3D = null;
            var _local_1:Vector3D = this.getVertex(0,0);
            var _local_2:Vector3D = this.getVertex(0,3);
            var _local_3:Vector3D = this.getVertex(1,0);
            var _local_4:Vector3D = this.getVertex(1,3);
        ...
        override protected function buildCross() : void {
            var _local_17:ObjectFace3D = null;
            var _local_1:Vector3D = this.getVertex(0,0);
            var _local_2:Vector3D = this.getVertex(0,3);
            var _local_3:Vector3D = this.getVertex(1,0);
            var _local_4:Vector3D = this.getVertex(1,3);
        ...
        protected function getVertex(param1:int, param2:int) : Vector3D {
            ...
            var _local_3:int = x_;
            var _local_4:int = y_;
            var _local_5:int = (param1 + rotation_) % 4;
            switch(_local_5) {
                case 1:
                    _local_3++;
                    break;
        ...
        protected function faceHelper(param1:Vector3D, param2:BitmapData, ... rest) : void {
            ...
            if(param1 != null || param2 != null) {
                ...
                while(_local_7 < obj3D_.faces_.length) {
                    obj3D_.faces_[_local_7].normalL_ = param1;
                    obj3D_.faces_[_local_7].texture_ = param2;
                    _local_7++;
                }
            }
        }
