package com.company.assembleegameclient.objects.animation {
    ...
    public class Animations {
        ...
        public function getTexture(param1:int) : BitmapData {
            var _local_2:AnimationData = null;
            ...
            if(this.nextRun_ == null) {
                ...
                for each(_local_2 in this.animationsData_.animations) {
                    this.nextRun_.push(_local_2.getLastRun(param1));
                }
            }
            if(this.running_ != null) {
                _local_4 = this.running_.getTexture(param1);
                if(_local_4 != null) {
                    return _local_4;
                }
                this.running_ = null;
            ...
            while(_local_3 < this.nextRun_.length) {
                if(param1 > this.nextRun_[_local_3]) {
                    _local_5 = this.nextRun_[_local_3];
                    _local_2 = this.animationsData_.animations[_local_3];
                    this.nextRun_[_local_3] = _local_2.getNextRun(param1);
...
class RunningAnimation {
    ...
    public function getTexture(param1:int) : BitmapData {
        ...
        while(param1 - this.frameStart_ > _local_2.time_) {
