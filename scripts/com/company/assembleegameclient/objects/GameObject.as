package com.company.assembleegameclient.objects {
    ...
    public class GameObject extends BasicObject {
        ...
        public static function damageWithDefense(param1:int, param2:int, param3:Boolean, param4:Vector.<uint>) : int {
            ...
            var _local_6:int = param1 * 3 / 20;
            var _local_7:int = Math.max(_local_6,param1 - _local_5);
        ...
        public function setAltTexture(param1:int) : void {
            var _local_3:TextureData = null;
            var _local_2:TextureData = ObjectLibrary.typeToTextureData_[this.objectType_];
            if(param1 == 0) {
                _local_3 = _local_2;
            } else {
                _local_3 = _local_2.getAltTextureData(param1);
                if(_local_3 == null) {
                    return;
                }
            }
        ...
        public function isSafe(param1:int = 20) : Boolean {
            ...
            for each(_local_2 in map_.goDict_) {
                if(_local_2 is Character && _local_2.props_.isEnemy_) {
                    _local_3 = x_ > _local_2.x_?int(x_ - _local_2.x_):int(_local_2.x_ - x_);
                    _local_4 = y_ > _local_2.y_?int(y_ - _local_2.y_):int(_local_2.y_ - y_);
                    if(_local_3 < param1 && _local_4 < param1) {
                        return false;
                    }
                }
            }
        ...
        public function distTo(param1:WorldPosData) : Number {
            var _local_2:Number = param1.x_ - x_;
            var _local_3:Number = param1.y_ - y_;
        ...
        override public function update(param1:int, param2:int) : Boolean {
            ...
            if(!(this.moveVec_.x == 0 && this.moveVec_.y == 0)) {
                if(this.myLastTickId_ < map_.gs_.gsc_.lastTickId_) {
                    ...
                    _local_4 = param1 - this.lastTickUpdateTime_;
        ...
        public function damage(param1:int, param2:int, param3:Vector.<uint>, param4:Boolean, param5:Projectile) : void {
            ...
            var _local_10:CharacterStatusText = null;
            var _local_11:PetsModel = null;
            var _local_12:PetVO = null;
            var _local_13:String = null;
            var _local_14:Vector.<uint> = null;
            ...
            if(param4) {
                ...
                _local_7 = 0;
                for each(_local_8 in param3) {
                    _local_9 = null;
                    if(param5 != null && param5.projProps_.isPetEffect_ && param5.projProps_.isPetEffect_[_local_8]) {
                        ...
                        if(_local_9 != null) {
                            if(_local_8 < ConditionEffect.NEW_CON_THREASHOLD) {
                                if((this.condition_[ConditionEffect.CE_FIRST_BATCH] | _local_9.bit_) == this.condition_[ConditionEffect.CE_FIRST_BATCH]) {
                                    continue;
                                }
                                this.condition_[ConditionEffect.CE_FIRST_BATCH] = this.condition_[ConditionEffect.CE_FIRST_BATCH] | _local_9.bit_;
                            } else {
                                if((this.condition_[ConditionEffect.CE_SECOND_BATCH] | _local_9.bit_) == this.condition_[ConditionEffect.CE_SECOND_BATCH]) {
                                    continue;
                                }
            ...
            if(!(this.props_.isEnemy_ && Parameters.data_.disableEnemyParticles)) {
                ...
                if(this.dead_) {
                    ...
                    map_.addObj(new HitEffect(_local_14,this.size_,10,param5.angle_,param5.projProps_.speed_),x_,y_);
                } else {
            ...
            if(param2 > 0) {
                ...
                this.showDamageText(param2,_local_15);
            }
        }
        
        public function showConditionEffect(param1:int, param2:String) : void {
            var _local_3:CharacterStatusText = new CharacterStatusText(this,16711680,3000,param1);
            _local_3.setStringBuilder(new LineBuilder().setParams(param2));
            map_.mapOverlay_.addStatusText(_local_3);
        }
        
        public function showConditionEffectPet(param1:int, param2:String) : void {
            var _local_3:CharacterStatusText = new CharacterStatusText(this,16711680,3000,param1);
            _local_3.setStringBuilder(new StaticStringBuilder("Pet " + param2));
            map_.mapOverlay_.addStatusText(_local_3);
        }
        
        public function showDamageText(param1:int, param2:Boolean) : void {
            var _local_3:String = "-" + param1;
            var _local_4:CharacterStatusText = new CharacterStatusText(this,!!param2?uint(9437439):uint(16711680),1000);
        ...
        protected function getTexture(param1:Camera, param2:int) : BitmapData {
            var _local_6:Pet = null;
            var _local_7:Number = NaN;
            var _local_8:int = 0;
            var _local_9:MaskedImage = null;
            var _local_10:int = 0;
            ...
            if(this is Pet) {
                ...
                } else if(!_local_6.isDefaultAnimatedChar) {
            ...
            if(this.animatedChar_ != null) {
                ...
                if(param2 < this.attackStart_ + ATTACK_PERIOD) {
                    ...
                    _local_7 = (param2 - this.attackStart_) % ATTACK_PERIOD / ATTACK_PERIOD;
                    ...
                    _local_7 = param2 % _local_10 / _local_10;
                }
                _local_9 = this.animatedChar_.imageFromFacing(this.facing_,param1,_local_8,_local_7);
                _local_3 = _local_9.image_;
                _local_5 = _local_9.mask_;
            } else if(this.animations_ != null) {
                _local_11 = this.animations_.getTexture(param2);
                if(_local_11 != null) {
                    _local_3 = _local_11;
                }
            }
            ...
            if(param1.isHallucinating_) {
                _local_12 = _local_3 == null?8:int(_local_3.width);
        ...
        override public function draw(param1:Vector.<IGraphicsData>, param2:Camera, param3:int) : void {
            ...
            var _local_4:BitmapData = this.getTexture(param2,param3);
            ...
            if(this.obj3D_ != null && !Parameters.isGpuRender()) {
                this.obj3D_.draw(param1,param2,this.props_.color_,_local_4);
                return;
            }
            if(this.obj3D_ != null && Parameters.isGpuRender()) {
                param1.push(null);
            ...
            if(Parameters.isGpuRender()) {
                ...
                } else if(_local_7 == 0 && GraphicsFillExtra.getSinkLevel(this.bitmapFill_) != 0) {
            ...
            if(this.flash_ != null) {
                if(!this.flash_.doneAt(param3)) {
                    if(Parameters.isGpuRender()) {
                        this.flash_.applyGPUTextureColorTransform(_local_4,param3);
                    } else {
                        _local_4 = this.flash_.apply(_local_4,param3);
                    }
                } else {
                    this.flash_ = null;
                }
            ...
            if(this.isShocked && !this.isShockedTransformSet) {
                if(Parameters.isGpuRender()) {
                    GraphicsFillExtra.setColorTransform(_local_4,new ColorTransform(-1,-1,-1,1,255,255,255,0));
                } else {
                    _local_8 = _local_4.clone();
                    _local_8.colorTransform(_local_8.rect,new ColorTransform(-1,-1,-1,1,255,255,255,0));
        ...
        public function drawConditionIcons(param1:Vector.<IGraphicsData>, param2:Camera, param3:int) : void {
            ...
            var _local_10:GraphicsBitmapFill = null;
            var _local_11:GraphicsPath = null;
            var _local_12:Number = NaN;
            var _local_13:Number = NaN;
            var _local_14:Matrix = null;
            if(this.icons_ == null) {
            ...
            while(_local_8 < _local_7) {
                ...
                param1.push(_local_10);
                param1.push(_local_11);
                param1.push(GraphicsUtil.END_FILL);
                _local_8++;
            }
        }
