package com.company.assembleegameclient.util {
    ...
    public class TileRedrawer {
        ...
        public static function redraw(param1:Square#61, param2:Boolean) : BitmapData {
        ...
        private static function getSig(param1:Square#61) : Array {
            var _local_6:int = 0;
        ...
        private static function getCompositeSig(param1:Square#61) : Array {
        ...
        private static function getEdgeSig(param1:Square#61) : Array {
            var _local_7:int = 0;
