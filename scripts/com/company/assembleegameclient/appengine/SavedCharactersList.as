package com.company.assembleegameclient.appengine {
    ...
    public class SavedCharactersList extends Event {
        ...
        public function getCharById(param1:int) : SavedCharacter {
            var _local_2:SavedCharacter = null;
            for each(_local_2 in this.savedChars_) {
                if(_local_2.charId() == param1) {
                    return _local_2;
                }
            }
            return null;
        ...
        private function parseBeginnersPackageData(param1:XML) : void {
            ...
            var _local_3:BeginnersPackageModel = null;
            if(param1.hasOwnProperty("BeginnerPackageTimeLeft")) {
                _local_2 = param1.BeginnerPackageTimeLeft;
        ...
        private function getBeginnerModel() : BeginnersPackageModel {
            ...
            var _local_2:BeginnersPackageModel = _local_1.getInstance(BeginnersPackageModel);
            return _local_2;
        }
        ...
        private function parseCharacterStatsData() : void {
            var _local_2:XML = null;
            var _local_3:int = 0;
            var _local_4:CharacterStats = null;
        ...
        public function bestLevel(param1:int) : int {
            var _local_2:CharacterStats = this.charStats_[param1];
            return _local_2 == null?0:int(_local_2.bestLevel());
        }
        
        public function bestOverallLevel() : int {
            var _local_2:CharacterStats = null;
            var _local_1:int = 0;
        ...
        public function bestFame(param1:int) : int {
            var _local_2:CharacterStats = this.charStats_[param1];
            return _local_2 == null?0:int(_local_2.bestFame());
        }
        ...
        public function levelRequirementsMet(param1:int) : Boolean {
            ...
            var _local_4:int = 0;
            var _local_2:XML = ObjectLibrary.xmlLibrary_[param1];
                ...
                if(!this.levelRequirementsMet(_local_6)) {
                    ...
                    for each(_local_9 in _local_5.UnlockLevel) {
                        ...
                        if(this.bestLevel(_local_10) < _local_11) {
                            if(_local_10 != param1 || _local_11 != param2) {
                                _local_7 = false;
                                break;
                            }
                            _local_8 = true;
