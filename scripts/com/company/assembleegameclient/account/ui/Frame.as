package com.company.assembleegameclient.account.ui {
    ...
    public class Frame extends Sprite {
        ...
        public function addTitle(param1:String) : void {
            var _local_2:TextFieldDisplayConcrete = new TextFieldDisplayConcrete().setSize(20).setColor(11711154).setBold(true);
        ...
        public function disable() : void {
            var _local_1:DeprecatedClickableText = null;
            mouseEnabled = false;
            mouseChildren = false;
            for each(_local_1 in this.navigationLinks_) {
                _local_1.setDefaultColor(11776947);
            }
        ...
        public function enable() : void {
            ...
            mouseChildren = true;
            for each(_local_1 in this.navigationLinks_) {
                _local_1.setDefaultColor(16777215);
            }
