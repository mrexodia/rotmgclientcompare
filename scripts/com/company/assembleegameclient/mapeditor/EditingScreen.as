package com.company.assembleegameclient.mapeditor {
    ...
    public class EditingScreen extends Sprite {
        ...
        private function onCheckBoxUpdated(param1:MouseEvent) : void {
            var _local_2:CheckBoxField = null;
            switch(param1.currentTarget) {
                ...
                case this.checkBoxArray[Layer.OBJECT]:
                    _local_2 = param1.currentTarget as CheckBoxField;
        ...
        private function onTilesEvent(param1:TilesEvent) : void {
            ...
            var _local_3:METile = null;
            var _local_4:int = 0;
            var _local_5:String = null;
            var _local_6:String = null;
            var _local_7:EditTileProperties = null;
            var _local_8:Vector.<METile> = null;
            var _local_9:Bitmap = null;
            var _local_10:uint = 0;
            _local_2 = param1.tiles_[0];
            switch(this.commandMenu_.getCommand()) {
                ...
                case MECommandMenu.EDIT_COMMAND:
                    ...
                    _local_7 = new EditTileProperties(param1.tiles_,_local_6);
                ...
                case MECommandMenu.CUT_COMMAND:
                    ...
                    for each(_local_2 in param1.tiles_) {
                    ...
                    this.addPasteCommandList(param1.tiles_,_local_8);
                ...
                case MECommandMenu.DROP_COMMAND:
                    if(this.pickObjHolder != null) {
                        ...
                        this.addModifyCommandList(param1.tiles_,Layer.OBJECT,_local_10);
        ...
        private function onEditComplete(param1:Event) : void {
            var _local_2:EditTileProperties = param1.currentTarget as EditTileProperties;
        ...
        private function addModifyCommandList(param1:Vector.<IntPoint>, param2:int, param3:int) : void {
            var _local_5:IntPoint = null;
            var _local_6:int = 0;
            var _local_4:CommandList = new CommandList();
            for each(_local_5 in param1) {
                _local_6 = this.meMap_.getType(_local_5.x_,_local_5.y_,param2);
                if(_local_6 != param3) {
                    _local_4.addCommand(new MEModifyCommand(this.meMap_,_local_5.x_,_local_5.y_,param2,_local_6,param3));
                }
            }
            if(_local_4.empty()) {
                return;
        ...
        private function addPasteCommandList(param1:Vector.<IntPoint>, param2:Vector.<METile>) : void {
            ...
            var _local_4:int = 0;
            for each(_local_5 in param1) {
                if(_local_4 >= param2.length) {
                    break;
                }
                _local_6 = this.meMap_.getTile(_local_5.x_,_local_5.y_);
                _local_3.addCommand(new MEReplaceCommand(this.meMap_,_local_5.x_,_local_5.y_,_local_6,param2[_local_4]));
                _local_4++;
            }
            if(_local_3.empty()) {
                return;
        ...
        private function addObjectNameCommandList(param1:Vector.<IntPoint>, param2:String) : void {
            var _local_4:IntPoint = null;
            var _local_5:String = null;
            var _local_3:CommandList = new CommandList();
            for each(_local_4 in param1) {
                _local_5 = this.meMap_.getObjectName(_local_4.x_,_local_4.y_);
                if(_local_5 != param2) {
                    _local_3.addCommand(new MEObjectNameCommand(this.meMap_,_local_4.x_,_local_4.y_,_local_5,param2));
                }
            }
            if(_local_3.empty()) {
                return;
        ...
        private function getEntry(param1:METile) : Object {
            var _local_3:Vector.<int> = null;
            var _local_4:String = null;
            var _local_5:Object = null;
            var _local_2:Object = {};
            if(param1 != null) {
                _local_3 = param1.types_;
        ...
        private function onFileLoadComplete(param1:Event) : void {
            ...
            var _local_11:int = 0;
            var _local_13:int = 0;
            var _local_14:Object = null;
            var _local_15:Array = null;
            var _local_16:Array = null;
            var _local_17:Object = null;
            var _local_18:Object = null;
            var _local_2:FileReference = param1.target as FileReference;
