package com.company.assembleegameclient.ui {
    ...
    public class Slot extends Sprite {
        ...
        protected function offsets(param1:int, param2:int, param3:Boolean) : Point {
            ...
            switch(param2) {
                case RING_TYPE:
                    _local_4.x = param1 == 2878?Number(0):Number(-2);
                    _local_4.y = !!param3?Number(-2):Number(0);
                    break;
                case SPELL_TYPE:
                    _local_4.y = -2;
            }
        ...
        protected function drawBackground() : void {
            ...
            var _local_5:BitmapTextFactory = null;
            ...
            if(this.backgroundImage_ == null) {
                if(_local_1 != null) {
                    ...
                    _local_1 = _local_5.make(new StaticStringBuilder(String(this.hotkey_)),26,3552822,true,IDENTITY_MATRIX,false);
                    this.backgroundImage_ = new Bitmap(_local_1);
