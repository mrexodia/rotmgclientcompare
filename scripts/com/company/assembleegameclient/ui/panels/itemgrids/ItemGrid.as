package com.company.assembleegameclient.ui.panels.itemgrids {
    ...
    public class ItemGrid extends Panel {
        ...
        public function ItemGrid(param1:GameObject, param2:Player, param3:int) {
            ...
            var _local_4:Container = param1 as Container;
            if(param1 == param2 || _local_4) {
        ...
        private function addToolTipToTile(param1:ItemTile) : void {
            ...
            if(param1.itemSprite.itemId > 0) {
                ...
                if(param1 is EquipmentTile) {
                    _local_2 = ItemConstants.itemTypeToName((param1 as EquipmentTile).itemType);
                } else {
                    _local_2 = TextKey.ITEM;
                }
                this.tooltip = new TextToolTip(3552822,10197915,null,TextKey.ITEM_EMPTY_SLOT,200,{"itemType":TextKey.wrapForTokenResolution(_local_2)});
            }
