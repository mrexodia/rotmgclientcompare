package com.company.assembleegameclient.ui.panels {
    ...
    public class ArenaPortalPanel extends Panel {
        ...
        private function makeTitle() : StaticTextDisplay {
            ...
            _local_1.setSize(18).setColor(16777215).setTextWidth(WIDTH).setWordWrap(true).setMultiLine(true).setAutoSize(TextFieldAutoSize.CENTER).setBold(true).setHTML(true);
