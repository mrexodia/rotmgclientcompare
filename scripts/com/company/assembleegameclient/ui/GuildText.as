package com.company.assembleegameclient.ui {
    ...
    public class GuildText extends Sprite {
        ...
        public function GuildText(param1:String, param2:int, param3:int = 0) {
            ...
            this.icon_.y = -8;
            this.icon_.x = -8;
            var _local_4:int = param3 == 0?0:int(param3 - (this.icon_.width - 16));
            this.guildName_ = new TextFieldDisplayConcrete().setSize(16).setColor(16777215).setTextWidth(_local_4);
