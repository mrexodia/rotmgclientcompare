package com.company.assembleegameclient.screens.charrects {
    ...
    public class CharacterRectList extends Sprite {
        ...
        public function CharacterRectList() {
            var _local_5:SavedCharacter = null;
            var _local_6:BuyCharacterRect = null;
            var _local_7:CharacterClass = null;
            var _local_8:CharacterStats = null;
            var _local_9:CurrentCharacterRect = null;
            var _local_10:int = 0;
            var _local_11:CreateNewCharacterRect = null;
            super();
        ...
        private function getIcon(param1:SavedCharacter, param2:int = 100) : DisplayObject {
            var _local_3:CharacterClass = this.classes.getCharacterClass(param1.objectType());
            var _local_4:CharacterSkin = _local_3.skins.getSkin(param1.skinType()) || _local_3.skins.getDefaultSkin();
            var _local_5:BitmapData = this.assetFactory.makeIcon(_local_4.template,param2,param1.tex1(),param1.tex2());
