package com.company.assembleegameclient.screens {
    ...
    public class NewCharacterScreen extends Sprite {
        ...
        public function initialize(param1:PlayerModel) : void {
            ...
            var _local_7:CharacterBox = null;
            ...
            while(_local_2 < ObjectLibrary.playerChars_.length) {
                ...
                if(!param1.isClassAvailability(_local_5,SavedCharactersList.UNAVAILABLE)) {
                    _local_6 = param1.isClassAvailability(_local_5,SavedCharactersList.UNRESTRICTED);
                    _local_7 = new CharacterBox(_local_3,param1.getCharStats()[_local_4],param1,_local_6);
        ...
        private function onCharBoxOver(param1:MouseEvent) : void {
            var _local_2:CharacterBox = param1.currentTarget as CharacterBox;
        ...
        private function onCharBoxClick(param1:MouseEvent) : void {
            this.tooltip.dispatch(null);
            var _local_2:CharacterBox = param1.currentTarget.parent as CharacterBox;
            ...
            while(_local_2 < ObjectLibrary.playerChars_.length) {
                ...
                if(!param1.isClassAvailability(_local_5,SavedCharactersList.UNAVAILABLE)) {
                    ...
                    if(_local_7) {
                        ...
                        if(_local_6 || param1.isLevelRequirementsMet(_local_4)) {
                            _local_7.unlock();
                        }
                    }
                }
