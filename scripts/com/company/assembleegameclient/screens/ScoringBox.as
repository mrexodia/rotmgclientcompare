package com.company.assembleegameclient.screens {
    ...
    public class ScoringBox extends Sprite {
        ...
        public function ScoringBox(param1:Rectangle, param2:XML) {
            ...
            this.addLine(TextKey.FAMEVIEW_BASEFAMEEARNED,null,0,param2.BaseFame,true,16762880,"","",new Bitmap(_local_3));
            for each(_local_4 in param2.Bonus) {
                this.addLine(_local_4.@id,_local_4.@desc,_local_4.@level,int(_local_4),true,16762880,"+","",new Bitmap(_local_3));
            }
        }
        
        public function showScore() : void {
            var _local_1:ScoreTextLine = null;
            this.animateScore();
        ...
        private function onEnterFrame(param1:Event) : void {
            ...
            var _local_6:ScoreTextLine = null;
