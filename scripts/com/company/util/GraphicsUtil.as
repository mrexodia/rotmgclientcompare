package com.company.util {
    ...
    public class GraphicsUtil {
        ...
        public static function getGradientMatrix(param1:Number, param2:Number, param3:Number = 0.0, param4:Number = 0.0, param5:Number = 0.0) : Matrix {
            ...
            _local_6.createGradientBox(param1,param2,param3,param4,param5);
            return _local_6;
        }
        ...
        public static function drawCircle(param1:Number, param2:Number, param3:Number, param4:GraphicsPath, param5:int = 8) : void {
            ...
            var _local_6:Number = 1 + 1 / (param5 * 1.75);
            param4.moveTo(param1 + param3,param2);
            var _local_7:int = 1;
            while(_local_7 <= param5) {
                _local_8 = TWO_PI * _local_7 / param5;
                _local_9 = TWO_PI * (_local_7 - 0.5) / param5;
                _local_10 = param1 + param3 * Math.cos(_local_8);
                _local_11 = param2 + param3 * Math.sin(_local_8);
                _local_12 = param1 + param3 * _local_6 * Math.cos(_local_9);
                _local_13 = param2 + param3 * _local_6 * Math.sin(_local_9);
                param4.curveTo(_local_12,_local_13,_local_10,_local_11);
                _local_7++;
            }
        }
