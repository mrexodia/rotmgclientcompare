package kabam.rotmg.util.components {
    ...
    public class LegacyBuyButton extends BuyButton {
        ...
        public function LegacyBuyButton(param1:String, param2:int, param3:int, param4:int, param5:Boolean = false) {
            ...
            var _local_6:StringBuilder = param1 != ""?this.lineBuilder.setParams(param1,{"cost":param3.toString()}):this.staticStringBuilder.setString(param3.toString());
        ...
        override public function setPrice(param1:int, param2:int) : void {
            var _local_3:StringBuilder = null;
            if(this.price != param1 || this.currency != param2) {
                this.price = param1;
                this.currency = param2;
                _local_3 = this.prefix != ""?this.lineBuilder.setParams(this.prefix,{"cost":param1.toString()}):this.staticStringBuilder.setString(param1.toString());
