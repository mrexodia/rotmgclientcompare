package kabam.rotmg.stage3D.graphic3D {
    ...
    public class Graphic3D {
        ...
        public function setGraphic(param1:GraphicsBitmapFill, param2:Context3DProxy) : void {
            ...
            param2.GetContext3D().setProgramConstantsFromVector(Context3DProgramType.FRAGMENT,2,Vector.<Number>([_local_3.redMultiplier,_local_3.greenMultiplier,_local_3.blueMultiplier,_local_3.alphaMultiplier]));
            param2.GetContext3D().setProgramConstantsFromVector(Context3DProgramType.FRAGMENT,3,Vector.<Number>([_local_3.redOffset / 255,_local_3.greenOffset / 255,_local_3.blueOffset / 255,_local_3.alphaOffset / 255]));
        }
        ...
        private function shadowTransform(param1:Number, param2:Number) : void {
            ...
            _local_3[12] = this.shadowMatrix2D.tx / param1;
            _local_3[13] = -this.shadowMatrix2D.ty / param2;
        ...
        public function render(param1:Context3DProxy) : void {
            ...
            param1.setProgram(_local_2.getProgram(param1,this.repeat));
