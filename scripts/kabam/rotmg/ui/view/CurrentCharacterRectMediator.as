package kabam.rotmg.ui.view {
    ...
    public class CurrentCharacterRectMediator extends Mediator {
        ...
        private function onSelected(param1:SavedCharacter) : void {
            var _local_2:CharacterClass = this.classesModel.getCharacterClass(param1.objectType());
            _local_2.setIsSelected(true);
            _local_2.skins.getSkin(param1.skinType()).setIsSelected(true);
        ...
        private function trackCharacterSelection(param1:SavedCharacter) : void {
            ...
            _local_2.label = param1.displayId();
            _local_2.value = param1.level();
