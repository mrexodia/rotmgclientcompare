    ...
    public class PotionSlotView extends Sprite {
        ...
        public function setData(param1:int, param2:int, param3:Boolean, param4:int = -1) : void {
            ...
            if(param4 != -1) {
                ...
                _local_7 = ObjectLibrary.getRedrawnTextureFromType(param4,55,false);
                this.potionIcon = new Bitmap(_local_7);
                this.potionIcon.y = -11;
                addChild(this.potionIcon);
                _local_7 = ObjectLibrary.getRedrawnTextureFromType(param4,80,true);
        ...
        private function onMouseMoveCheckDrag(param1:MouseEvent) : void {
            var _local_2:Number = param1.stageX - this.dragStart.x;
            var _local_3:Number = param1.stageY - this.dragStart.y;
