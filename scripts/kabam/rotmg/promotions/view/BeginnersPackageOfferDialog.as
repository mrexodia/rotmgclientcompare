package kabam.rotmg.promotions.view {
    ...
    public class BeginnersPackageOfferDialog extends Sprite {
        ...
        public function setTimeRemaining(param1:int) : void {
            var _local_2:String = param1 > 1?LANGUAGE_KEY_PLURAL:LANGUAGE_KEY_SINGULAR;
            this.timeText.setStringBuilder(new LineBuilder().setParams(_local_2,{"days":param1}));
        }
        ...
        private function makeTransparentTargetButton(param1:int, param2:int, param3:int, param4:int) : Sprite {
            var _local_5:TransparentButton = new TransparentButton(param1,param2,param3,param4);
            addChild(_local_5);
            return _local_5;
        }
    }
