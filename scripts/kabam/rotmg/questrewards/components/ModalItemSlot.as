    ...
    public class ModalItemSlot extends FoodFeedFuseSlot {
        ...
        public function ModalItemSlot(param1:Boolean = false, param2:Boolean = false) {
            ...
            if(param2) {
                _local_4 = 0;
                while(_local_4 < 3) {
                    _local_3 = PetsViewAssetFactory.returnPetSlotShape(56 + _local_4 * 10,5526612,-5 + -5 * _local_4,false,true,4);
                    addChild(_local_3);
        ...
        public function setUsageText(param1:String, param2:int, param3:int) : void {
            ...
            _local_4.apply(this.usageText,param2,param3,false,true);
        ...
        public function setEmbeddedImage(param1:Bitmap) : void {
            ...
            var _local_2:Bitmap = new Bitmap(param1.bitmapData);
