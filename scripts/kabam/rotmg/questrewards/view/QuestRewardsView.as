package kabam.rotmg.questrewards.view {
    ...
    public class QuestRewardsView extends EmptyFrame {
        ...
        public function init(param1:int, param2:int, param3:String, param4:String) : void {
            var _local_7:TextField = null;
            var _local_10:TextFormat = null;
            var _local_5:String = "Tier " + param1.toString();
            ...
            addChild(_local_7);
            var _local_8:String = LineBuilder.getLocalizedStringFromKey(ObjectLibrary.typeToDisplayId_[param2]);
            this.constructDescription(param3,_local_8);
            this.addCloseButton();
            ...
            var _local_9:BitmapData = ObjectLibrary.getRedrawnTextureFromType(param2,80,true,false);
        ...
        public function noNewQuests() : void {
            ...
            var _local_5:TextFormat = _local_4.apply(_local_1,32,16777215,true,true);
        ...
        public function constructDescription(param1:String, param2:String = "") : void {
            ...
            var _local_6:TextFormat = null;
            var _local_3:int = param1.indexOf("{goal}");
            if(_local_3 != -1) {
                _local_4 = param1.split("{goal}").join(param2);
            ...
            if(_local_3 != -1) {
                _local_6 = desc.getTextFormat(_local_3,_local_3 + param2.length);
                _local_6.color = 196098;
                _local_6.bold = true;
                desc.setTextFormat(_local_6,_local_3,_local_3 + param2.length);
            }
        }
