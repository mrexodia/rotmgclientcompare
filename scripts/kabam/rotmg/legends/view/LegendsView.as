package kabam.rotmg.legends.view {
    ...
    public class LegendsView extends Sprite {
        ...
        private function makeTab(param1:Timespan, param2:int) : LegendsTab {
            var _local_3:LegendsTab = new LegendsTab(param1);
            this.tabs[param1.getId()] = _local_3;
            _local_3.x = 20 + param2 * 90;
            _local_3.y = 70;
        ...
        private function clearLegendsList() : void {
            var _local_1:LegendListItem = null;
        ...
        private function makeItemFromLegend(param1:int) : LegendListItem {
            var _local_2:Legend = this.legends[param1];
            _local_2.place = param1 + 1;
            var _local_3:LegendListItem = new LegendListItem(_local_2);
            _local_3.y = param1 * LegendListItem.HEIGHT;
