package kabam.rotmg.dailyLogin.view {
    ...
    public class DailyCalendarInfoIcon extends Sprite implements TooltipAble {
        ...
        public function DailyCalendarInfoIcon(param1:String = "", param2:String = "", param3:Object = null) {
            ...
            super();
            var _local_4:TextFieldDisplayConcrete = new TextFieldDisplayConcrete().setSize(CalendarSettings.TABS_FONT_SIZE).setColor(16777215).setTextWidth(15).setAutoSize(TextFieldAutoSize.CENTER).setBold(true).setSize(22);
