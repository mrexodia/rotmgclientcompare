package kabam.rotmg.chat.view {
    ...
    public class ChatInputMediator extends Mediator {
        ...
        private function makeTextfield() : TextField {
            ...
            this.fontModel.apply(_local_1,14,16777215,true);
            return _local_1;
        }
        ...
        private function processKeyUp(param1:KeyboardEvent) : void {
            ...
            var _local_2:uint = param1.keyCode;
            if(_local_2 == this.chatShortcutModel.getCommandShortcut()) {
                this.view.activate("/",true);
            } else if(_local_2 == this.chatShortcutModel.getChatShortcut()) {
                this.view.activate(null,true);
            } else if(_local_2 == this.chatShortcutModel.getGuildShortcut()) {
                this.view.activate("/g ",true);
            } else if(_local_2 == this.chatShortcutModel.getTellShortcut()) {
                this.handleTell();
            }
        }
