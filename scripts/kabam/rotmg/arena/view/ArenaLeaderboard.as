package kabam.rotmg.arena.view {
    ...
    public class ArenaLeaderboard extends Sprite {
        ...
        public function destroy() : void {
            var _local_1:ArenaLeaderboardTab = null;
        ...
        private function makeTabs() : Vector.<ArenaLeaderboardTab> {
            var _local_3:ArenaLeaderboardFilter = null;
            var _local_4:ArenaLeaderboardTab = null;
        ...
        private function makeTitle() : StaticTextDisplay {
            ...
            _local_1.setBold(true).setColor(11776947).setSize(32);
        ...
        private function alignTabs() : void {
            var _local_2:ArenaLeaderboardTab = null;
            var _local_1:int = 20;
        ...
        private function makeResetTimer() : LeaderboardWeeklyResetTimer {
            var _local_1:LeaderboardWeeklyResetTimer = null;
