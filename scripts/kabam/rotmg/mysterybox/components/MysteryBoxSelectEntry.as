package kabam.rotmg.mysterybox.components {
    ...
    public class MysteryBoxSelectEntry extends Sprite {
        ...
        private function addUnitsLeftText() : * {
            ...
            var _local_2:int = 0;
            if(this.mbi.unitsLeft >= 0) {
                _local_2 = this.mbi.unitsLeft / this.mbi.totalUnits;
                if(_local_2 <= 0.1) {
                    _local_1 = 16711680;
                } else if(_local_2 <= 0.5) {
                    _local_1 = 16754944;
                } else {
                    _local_1 = 65280;
                }
        ...
        private function addSaleText() : void {
            ...
            if(this.mbi.isOnSale()) {
                ...
                _local_2 = this.getText("",this.buyButton.x,this.buyButton.y + this.buyButton.height + 10,10).setColor(16711680);
                _local_2.setStringBuilder(_local_1);
                addChild(_local_2);
                _local_3 = this.getText(LineBuilder.getLocalizedStringFromKey("MysteryBoxSelectEntry.was") + " " + this.mbi.priceAmount + " " + this.mbi.currencyName,this.buyButton.x,this.buyButton.y - 14,10).setColor(16711680);
                addChild(_local_3);
            }
        }
        ...
        public function getText(param1:String, param2:int, param3:int, param4:int = 12, param5:Boolean = false) : TextFieldDisplayConcrete {
            var _local_6:TextFieldDisplayConcrete = new TextFieldDisplayConcrete().setSize(param4).setColor(16777215).setTextWidth(MysteryBoxSelectModal.modalWidth - 185);
            _local_6.setBold(true);
            if(param5) {
                _local_6.setStringBuilder(new StaticStringBuilder(param1));
            } else {
                _local_6.setStringBuilder(new LineBuilder().setParams(param1));
            }
        ...
        private function addInfoImageChild() : void {
            ...
            var _local_4:ColorMatrixFilter = null;
            if(this.infoImage == null) {
                return;
            }
            var _local_1:int = 8;
