package kabam.rotmg.mysterybox.components {
    ...
    public class MysteryBoxRollModal extends Sprite {
        ...
        public function getText(param1:String, param2:int, param3:int, param4:Boolean = false) : TextFieldDisplayConcrete {
            var _local_5:TextFieldDisplayConcrete = new TextFieldDisplayConcrete().setSize(16).setColor(16777215).setTextWidth(WIDTH - TEXT_MARGIN * 2);
        ...
        public function moneyCheckPass() : Boolean {
            ...
            if(_local_1 == Currency.GOLD && _local_5 < _local_2) {
                ...
                _local_3 = false;
            } else if(_local_1 == Currency.FAME && _local_4 < _local_2) {
                _local_7 = StaticInjectorContext.getInjector().getInstance(OpenDialogSignal);
        ...
        private function doEaseInAnimation(param1:DisplayObject, param2:Object = null, param3:Object = null) : void {
            var _local_4:GTween = new GTween(param1,0.5 * 1,param2,{"ease":Sine.easeOut});
            _local_4.nextTween = new GTween(param1,0.5 * 1,param3,{"ease":Sine.easeIn});
            _local_4.nextTween.paused = true;
        }
        
        private function shelveReward() : void {
            var _local_2:ItemWithTooltip = null;
            var _local_3:int = 0;
            var _local_4:int = 0;
            var _local_5:int = 0;
            var _local_6:int = 0;
        ...
        private function clearShelveReward() : void {
            var _local_1:ItemWithTooltip = null;
