package kabam.rotmg.game.view.components {
    ...
    public class StatsView extends Sprite {
        ...
        private function createStat(param1:int, param2:int) : StatView {
            var _local_4:StatView = null;
            var _local_3:StatModel = statsModel[param1];
            _local_4 = new StatView(_local_3.name,_local_3.abbreviation,_local_3.description,_local_3.redOnZero);
            _local_4.x = param1 % 2 * this.WIDTH / 2;
            _local_4.y = param2 * (this.HEIGHT / 3);
            return _local_4;
        }
