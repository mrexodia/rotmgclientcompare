package kabam.rotmg.game.view {
    ...
    public class GameSpriteMediator extends Mediator {
        ...
        public static function sleepForMs(param1:int) : void {
            ...
            while(getTimer() - _local_2 < param1) {
            }
        }
        ...
        private function onReconnect(param1:ReconnectEvent) : void {
            ...
            _local_2.server = param1.server_;
            _local_2.gameId = param1.gameId_;
            _local_2.createCharacter = param1.createCharacter_;
            _local_2.charId = param1.charId_;
            _local_2.keyTime = param1.keyTime_;
            _local_2.key = param1.key_;
            _local_2.isFromArena = param1.isFromArena_;
