package kabam.rotmg.game.view {
    ...
    public class SellableObjectPanel extends Panel implements TooltipAble {
        ...
        private static function createGuildRankReqText(param1:int) : TextFieldDisplayConcrete {
            ...
            _local_2 = new TextFieldDisplayConcrete().setSize(16).setColor(16711680).setBold(true).setAutoSize(TextFieldAutoSize.CENTER);
            var _local_3:String = GuildUtil.rankToString(param1);
        ...
        override public function draw() : void {
            ...
            } else if(_local_1.guildRank_ < this.owner_.guildRankReq_) {
                if(contains(this.buyButton_)) {
                    removeChild(this.buyButton_);
                }
