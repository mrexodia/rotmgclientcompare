    ...
    public class NameChangerPanel extends Panel {
        ...
        public function NameChangerPanel(param1:GameSprite, param2:int) {
            ...
            if(this.hasMapAndPlayer()) {
                ...
                } else if(_local_3.numStars_ < param2) {
        ...
        private function handleInsufficientRank(param1:int) : void {
            ...
            addChild(this.title_);
            _local_2 = new Sprite();
            var _local_3:TextFieldDisplayConcrete = new TextFieldDisplayConcrete().setSize(16).setColor(16777215);
            ...
            _local_4 = new RankText(param1,false,false);
