package kabam.rotmg.minimap.view {
    ...
    public class MiniMapImp extends MiniMap {
        ...
        public static function gameObjectToColor(param1:GameObject) : uint {
            var _local_2:* = param1.objectType_;
            if(!objectTypeColorDict_.hasOwnProperty(_local_2)) {
                objectTypeColorDict_[_local_2] = param1.getColor();
            }
        ...
        override public function setGroundTile(param1:int, param2:int, param3:uint) : void {
            var _local_4:uint = GroundLibrary.getColor(param3);
            this.miniMapData_.setPixel(param1,param2,_local_4);
        }
        
        override public function setGameObjectTile(param1:int, param2:int, param3:GameObject) : void {
            var _local_4:uint = gameObjectToColor(param3);
            this.miniMapData_.setPixel(param1,param2,_local_4);
        }
        ...
        private function areSamePlayers(param1:Vector.<Player>, param2:Vector.<Player>) : Boolean {
            var _local_3:int = param1.length;
            if(_local_3 != param2.length) {
                return false;
            }
            var _local_4:int = 0;
            while(_local_4 < _local_3) {
                if(param1[_local_4] != param2[_local_4]) {
                    return false;
                }
                _local_4++;
            }
