package kabam.rotmg.text.view.stringBuilder {
    ...
    public class LineBuilder implements StringBuilder {
        ...
        public static function getLocalizedStringFromJSON(param1:String) : String {
            ...
            var _local_3:StringMap = null;
            if(param1.charAt(0) == "{") {
                _local_2 = LineBuilder.fromJSON(param1);
        ...
        public static function returnStringReplace(param1:String, param2:Object = null, param3:String = "", param4:String = "") : String {
            ...
            var _local_8:* = null;
            var _local_5:String = stripCurlyBrackets(param1);
            for(_local_6 in param2) {
                _local_7 = param2[_local_6];
                _local_8 = "{" + _local_6 + "}";
        ...
        private static function stripCurlyBrackets(param1:String) : String {
            var _local_2:Boolean = param1 != null && param1.charAt(0) == "{" && param1.charAt(param1.length - 1) == "}";
            return !!_local_2?param1.substr(1,param1.length - 2):param1;
        }
