package kabam.rotmg.text.view {
    ...
    public class BitmapTextFactory {
        ...
        private function makeBitmapData(param1:Boolean, param2:Matrix) : BitmapData {
            var _local_3:int = this.textfield.width + this.padding + param2.tx;
            var _local_4:int = this.textfield.height + this.padding;
            var _local_5:BitmapData = new BitmapDataSpy(_local_3,_local_4,true,0);
            _local_5.draw(this.textfield,param2);
            param1 && _local_5.applyFilter(_local_5,_local_5.rect,PointUtil.ORIGIN,this.glowFilter);
            return _local_5;
        }
    }
}
