package kabam.rotmg.fortune.components {
    ...
    public class ItemWithTooltip extends Sprite implements TooltipAble {
        ...
        public function ItemWithTooltip(param1:int, param2:int = 100, param3:Boolean = false) {
            ...
            super();
            this.itemId = param1;
            var _local_4:BitmapData = ObjectLibrary.getRedrawnTextureFromType(param1,param2,true,false);
            var _local_5:BitmapData = ObjectLibrary.getRedrawnTextureFromType(param1,param2,true,false);
