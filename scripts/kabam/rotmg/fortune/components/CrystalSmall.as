    ...
    public class CrystalSmall extends Sprite {
        ...
        public function CrystalSmall() {
            ...
            while(_local_2 < 3) {
                ...
                _local_1 = TextureRedrawer.redraw(_local_1,this.size_,true,16777215,true);
            ...
            _local_1 = AssetLibrary.getImageFromSet("lofiCharBig",256);
        ...
        public function doItemCenter(param1:Number, param2:Number) : void {
            this.returnX = this.x;
            this.returnY = this.y;
            var _local_3:Number = this.calculateXPos(param1);
            var _local_4:Number = this.calculateYPos(param2);
