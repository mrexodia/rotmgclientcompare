package kabam.rotmg.fortune.components {
    ...
    public class FortuneModal extends EmptyFrame {
        ...
        public static function doEaseOutInAnimation(param1:DisplayObject, param2:Object = null, param3:Object = null, param4:Function = null) : void {
            var _local_5:GTween = new GTween(param1,0.5 * 1,param2,{"ease":Sine.easeOut});
            _local_5.nextTween = new GTween(param1,0.5 * 1,param3,{"ease":Sine.easeIn});
            _local_5.nextTween.paused = true;
            _local_5.nextTween.end();
            _local_5.nextTween.onComplete = param4;
        }
        ...
        private function InitTexts() : void {
            ...
            while(_local_3 < _local_1.length) {
                ...
                _local_4.filters = [new GlowFilter(16777215,1,2,2,1.5,1)];
        ...
        private function onItemSwitch(param1:TimerEvent = null) : void {
            var _local_5:ItemWithTooltip = null;
        ...
        private function doEaseInAnimation(param1:DisplayObject, param2:Object = null, param3:Function = null) : void {
            var _local_4:GTween = new GTween(param1,0.5,param2,{
                "ease":Sine.easeOut,
                "onComplete":param3
            });
        }
        ...
        private function onCountdownComplete() : void {
            var _local_2:int = 0;
            var _local_1:CrystalSmall = null;
            do {
        ...
        private function onFirstBuySub(param1:int) : void {
            var _local_4:OpenDialogSignal = null;
            ...
            if(_local_2 != null) {
                if(param1 == Currency.GOLD && this.state == STATE_ROUND_2 && _local_2.credits_ - this.goldPriceSecond_ < 0) {
                    _local_4 = StaticInjectorContext.getInjector().getInstance(OpenDialogSignal);
                    _local_4.dispatch(new NotEnoughGoldDialog());
                    return;
                }
                if(param1 == Currency.GOLD && _local_2.credits_ - this.goldPrice_ < 0) {
                    _local_4 = StaticInjectorContext.getInjector().getInstance(OpenDialogSignal);
                    _local_4.dispatch(new NotEnoughGoldDialog());
                    return;
                }
                if(param1 == Currency.FORTUNE && _local_2.tokens_ - this.tokenPrice_ < 0) {
                    return;
                }
            }
            ...
            if(param1) {
                ...
                if(_local_4 != null) {
                    if(_local_3.hasOwnProperty("Gold")) {
                        ...
                        this.creditDisplay_.draw(_local_4.credits_,0,_local_4.tokens_);
                    } else if(_local_3.hasOwnProperty("FortuneToken")) {
                ...
                for each(_local_17 in this.items) {
                    ...
                    if(_local_7) {
                        ...
                        _local_6 = --_local_6 < 0?2:int(_local_6);
                    }
                }
        ...
        private function onFirstBuyAnimateComplete() : void {
            ...
            while(_local_1 < 3) {
                if(!(this.state == STATE_ROUND_2 && this.crystals[_local_1] == this.crystalClicked)) {
                    ...
                    new TimerCallback(this.NOVA_DELAY_TIME,this.doNova,int(this.crystals[_local_1].returnCenterX()),int(this.crystals[_local_1].returnCenterY()),5,65535);
        ...
        private function handleError() : void {
            var _local_1:OpenDialogSignal = null;
        ...
        private function onErrorOk(param1:Event) : void {
            var _local_2:CloseDialogsSignal = null;
        ...
        private function smallBallClick(param1:Object) : void {
            ...
            var _local_3:int = 0;
            while(_local_3 < 3) {
                if(this.crystals[_local_3] == param1) {
        ...
        private function onSmallBallClickCompleteRound2(param1:int) : void {
            ...
            while(_local_2 < this.items.length) {
                if(int(this.items[_local_2]) == param1) {
        ...
        private function ballClickEnable(param1:CrystalSmall = null) : void {
            var _local_2:int = 0;
            while(_local_2 < 3) {
                if(this.crystals[_local_2] == param1) {
        ...
        private function resetBalls() : void {
            ...
            while(_local_2 < 3) {
                ...
                } else if(this.crystals[_local_2].visible == false) {
        ...
        private function doNova(param1:Number, param2:Number, param3:int = 20, param4:int = 12447231) : void {
            ...
            var _local_6:NovaEffect = null;
            if(this.particleMap != null) {
                _local_5 = new GameObject(null);
                _local_5.x_ = ParticleModalMap.getLocalPos(param1);
                _local_5.y_ = ParticleModalMap.getLocalPos(param2);
                _local_6 = new NovaEffect(_local_5,param3,param4);
        ...
        private function doLightning(param1:Number, param2:Number, param3:Number, param4:Number, param5:int = 200, param6:int = 12447231) : void {
            ...
            _local_7.x_ = ParticleModalMap.getLocalPos(param1);
            _local_7.y_ = ParticleModalMap.getLocalPos(param2);
            var _local_8:WorldPosData = new WorldPosData();
            _local_8.x_ = ParticleModalMap.getLocalPos(param3);
            _local_8.y_ = ParticleModalMap.getLocalPos(param4);
            var _local_9:LightningEffect = new LightningEffect(_local_7,_local_8,param6,param5);
