package kabam.rotmg.packages.view {
    ...
    public class PackageOfferDialog extends Sprite implements Resizable {
        ...
        private function makeBuyNow() : DeprecatedTextButton {
            var _local_1:DeprecatedTextButton = new DeprecatedTextButton(16,TextKey.PACKAGE_OFFER_DIALOG_BUY_NOW);
            return _local_1;
        }
        
        private function makeTitle() : TextFieldDisplayConcrete {
            var _local_1:TextFieldDisplayConcrete = new TextFieldDisplayConcrete().setSize(this.fontSize).setColor(11776947);
