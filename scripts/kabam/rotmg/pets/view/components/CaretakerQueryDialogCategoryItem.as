package kabam.rotmg.pets.view.components {
    ...
    public class CaretakerQueryDialogCategoryItem extends Sprite {
        ...
        private function makeTextfield() : TextFieldDisplayConcrete {
            var _local_1:TextFieldDisplayConcrete = new TextFieldDisplayConcrete().setSize(16).setColor(16777215).setBold(true).setAutoSize(TextFieldAutoSize.CENTER).setVerticalAlign(TextFieldDisplayConcrete.MIDDLE).setPosition(WIDTH / 2,HEIGHT / 2);
