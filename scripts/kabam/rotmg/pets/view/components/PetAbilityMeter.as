package kabam.rotmg.pets.view.components {
    ...
    public class PetAbilityMeter extends Sprite implements TooltipAble {
        ...
        public function initializeData(param1:AbilityVO) : void {
            ...
            if(this.unlocked) {
                _local_2 = Math.max(0,PetsAbilityLevelHelper.getCurrentPointsForLevel(param1.points,param1.level));
                _local_3 = PetsAbilityLevelHelper.getAbilityPointsforLevel(param1.level);
                _local_2 = param1.level >= this.max?int(_local_3):int(_local_2);
        ...
        public function setLevelLabel(param1:int, param2:Boolean = false) : void {
            var _local_3:String = param1 >= this.max?TextKey.PET_ABILITY_LEVEL_MAX:TextKey.ABILITY_BAR_LEVEL_LABEL;
            ...
            this.labelTextfield.setStringBuilder(new LineBuilder().setParams(_local_3,{"level":param1.toString()}));
        ...
        public function setUnlocked(param1:Boolean) : void {
            ...
            if(this.unlocked != param1) {
                ...
                _local_2 = !!param1?11776947:5658198;
                _local_3 = !!param1?[new DropShadowFilter(0,0,0)]:[];
