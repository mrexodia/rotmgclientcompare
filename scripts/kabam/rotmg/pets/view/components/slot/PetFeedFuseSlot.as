package kabam.rotmg.pets.view.components.slot {
    ...
    public class PetFeedFuseSlot extends FeedFuseSlot {
        ...
        public function setPetIcon(param1:PetVO) : void {
            var _local_2:PetIcon = this.petIconFactory.create(param1,48);
            setIcon(_local_2);
        }
        
        public function setPet(param1:PetVO) : void {
            var _local_2:AppendingLineBuilder = null;
            if(param1) {
                this.setPetIcon(param1);
                setTitle(TextKey.BLANK,{"data":param1.getName()});
                _local_2 = new AppendingLineBuilder();
                _local_2.pushParams(param1.getRarity());
                this.showFamily && _local_2.pushParams(PetFamilyKeys.getTranslationKey(param1.getFamily()));
        ...
        public function setProcessing(param1:Boolean) : void {
            ...
            if(this.processing != param1) {
                ...
                _local_2 = !!param1?MoreColorUtil.darkCT:new ColorTransform();
