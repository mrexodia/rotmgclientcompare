package kabam.rotmg.pets.view.components.slot {
    ...
    public class FeedFuseSlot extends Sprite {
        ...
        public function hideOuterSlot(param1:Boolean) : void {
            ...
            var _local_2:int = !!param1?40:46;
            var _local_3:int = !!param1?3:0;
        ...
        public function highlight(param1:Boolean, param2:int = 16777103, param3:Boolean = false) : void {
            var _local_5:ColorTransform = null;
            var _local_4:ColorTransform = this.innerSlot.transform.colorTransform;
            _local_4.color = !!param1?uint(param2):uint(5526612);
            ...
            if(this.outerSlot.visible) {
                ...
                _local_5.color = !!param3?uint(param2):uint(5526612);
