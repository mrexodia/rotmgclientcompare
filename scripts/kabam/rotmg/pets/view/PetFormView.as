package kabam.rotmg.pets.view {
    ...
    public class PetFormView extends PetInteractionView implements DialogCloser {
        ...
        public function createSkinGroups(param1:Vector.<PetSkinGroup>) : void {
            var _local_2:PetSkinGroup = null;
            var _local_3:uint = 0;
            while(_local_3 < this.NUM_CATEGORIES) {
                _local_2 = param1[_local_3];
                this.skinGroups = param1;
                param1[_local_3].initComplete.add(this.onSkinGroupInit);
                this.reskinContainer.addChild(param1[_local_3]);
                _local_3++;
            }
        }
