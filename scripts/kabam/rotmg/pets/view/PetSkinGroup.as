package kabam.rotmg.pets.view {
    ...
    public class PetSkinGroup extends Sprite {
        ...
        private function createIconSquares() : void {
            var _local_1:uint = 0;
            var _local_3:PetIcon = null;
            var _local_4:PetItem = null;
            var _local_5:FeedFuseSlot = null;
            var _local_6:NativeSignal = null;
        ...
        private function createPetIcon(param1:PetVO, param2:int) : PetIcon {
            ...
            var _local_4:PetIcon = _local_3.create(param1,param2);
        ...
        public function onSlotSelected(param1:int) : void {
            var _local_2:FeedFuseSlot = null;
            var _local_3:int = 0;
            var _local_4:uint = 0;
            while(_local_4 < this.slots.length) {
                ...
                _local_2.highlight(_local_3 == param1);
                _local_4++;
            }
        }
    }
